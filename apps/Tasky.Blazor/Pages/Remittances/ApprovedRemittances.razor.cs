...
= new GetRemittanceListPagedAndSortedResultRequestDto();
        ...
        private async Task UpdateRemittanceToReleaseAsync(Guid editingRemittanceId, CreateUpdateRemittanceDto updateRemittance)
        {
            RemittanceDto remittance = ObjectMapper.Map<CreateUpdateRemittanceDto, RemittanceDto>(updateRemittance);
